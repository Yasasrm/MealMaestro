...
app.post("/getMealPlan", async (req, res) => {
    try {
        ...
        const dietaryRequirements = {
            Requirement:
                "I need a dietary plan for the following requirements. Give results according to the ResultsNeededFormat only. No other contents, do not put any characters not related to the JSON",
            Requirements: {
                Age: userInput.age || "",
        ...
        const cleanedString = mealPlan.replace(/\n\n/g, ',').replace(/\n/g, '').replace(/,\s*$/, '');
